...
namespace GetSystemInfo
{
    ...
    public static class ISO3166
    {
        ...
        public static List<ISO3166Country> FromPhoneCode(string code)
        {
            return GetCollection().Where(p => p.DialCodes != null && p.DialCodes.Length > 0 && p.DialCodes[0] == code).ToList();
        }
